...
if len(checkpoint_files) == 0:
	...
	model = tf.keras.models.load_model(checkpoint_path, custom_objects={'euclidean_distance_loss': euclidean_distance_loss})
...
# Ahora sí, a entrenar!
model.fit(sequential_input, epochs=1, batch_size=64, callbacks=[lRateSchedulerCallback], use_multiprocessing=True, workers=16)
